...
def params():
	...
	parser.add_argument('--n_epochs', default=2, type=int, help='number of epochs (after each epoch, the model gets saved)')
	parser.add_argument('--n_grad_steps', default=10, type=int, help='number of gradient descent steps')
	parser.add_argument('--hidden_size', default=5, type=int, help='hidden size of network (default: 20)')
	parser.add_argument('--n_batches_per_epoch', default=5, type=int, help='number of batches per epoch (default: 5000)')
	parser.add_argument('--batch_size', default=2, type=int, help='batch size (default: 100)')
	...
	parser.add_argument('--average_sequence_length', default=50, type=int, help='average sequence length in dataset (default: 5000)')
